...
const Index = () => {
  ...
  const [trainMode, setTrainMode] = useState<"step" | "continuous">(
    "continuous",
  );
    ...
    <div className="min-h-screen p-4 md:p-8 flex flex-col bg-gradient-to-b from-background to-background/95">
      <header className="mb-6 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Interactive educational tool for understanding neural networks. Build,
          train, and visualize neural networks in real-time.
        </p>
      </header>
      ...
      <footer className="mt-8 text-center text-sm text-muted-foreground">
        <p>
          Neural Network Visualizer - Built with TensorFlow.js, D3.js, and React
        </p>
      </footer>
    </div>
  );
